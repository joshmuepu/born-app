/**
 * schema.ts — the SQLite schema for the sermon database.
 * No Electron deps so it can be reused by the build-time DB generator
 * (scripts/build-sermon-db.ts) and unit tests.
 */
